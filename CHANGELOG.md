...
## Version 1.2.11 - 2022.8.30

## Version 1.2.10 - 2022.8.30
...
- 增加了请求的Platform和OS的获取，在登录时，默认设置的deviceType为platform名称
- 现在默认不对同类型设备进行登录数量限制（之前为同类型设备限制1个）

## Version 1.2.5，1.2.6 - 2022.8.17

### Fixed

- 修复了一些bug

## Version 1.2.4 - 2022.8.14

### Fixed

- 修复了一些bug

## Version 1.2.3 - 2022.8.10

### Fixed

- 修复了一些bug

## Version 1.2.2 - 2022.8.9

### Fixed

- 修复了一些bug

## Version 1.2.1 - 2022.8.9
...
## <span style="color: red">~~Version 1.1.4~~</span>  - 2022.7.13
